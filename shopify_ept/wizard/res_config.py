...
class ShopifyInstanceConfig(models.TransientModel):
    ...
    def reset_credentials(self):
        ...
        if instance.shopify_api_key == self.shopify_api_key or instance.shopify_password == self.shopify_password or \
            ...
            raise UserError("Entered credentials are same as previous.\nPlease verify the credentials once.")
...
class ResConfigSettings(models.TransientModel):
    ...
    shopify_date_deadline = fields.Integer("Deadline Lead Days for Shopify",
    ...
    shopify_financial_status_ids = fields.Many2many(
        ...
        string='Shopify Financial Status', default=_get_shopify_default_financial_statuses)
