...
class shopify_cancel_order_wizard(models.TransientModel):
    ...
    def default_get(self,fields):
        ...
        res.update({'suggested_amount':self.get_amount(),'company_id':picking.company_id.id,'notify_by_email':picking.shopify_instance_id.notify_by_email_while_cancel_picking})
        return res
